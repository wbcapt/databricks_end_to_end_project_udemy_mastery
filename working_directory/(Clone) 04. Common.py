...
# MAGIC %md
# MAGIC
# MAGIC # Create a common notebook
# MAGIC
# MAGIC Purpose: To re-use common functions and variables across different notebooks
# MAGIC
# MAGIC Running a common notebook is used with the magic command
# MAGIC
